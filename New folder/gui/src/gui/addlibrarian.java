...
public void SaveFile() throws FileNotFoundException, IOException {
        ...
        pw.println(u[count].getName() + "," + u[count].getPassword() + ","+u[count].getId()+"," + u[count].getEmail() + "," + u[count].getAddress() + "," + u[count].getCity() + "," + u[count].getContactno());
...
if (email.contains("@") && email.contains(".")&&(isValidID(Id)==true)&&(isValidContactno(contactno)==true))
{
 u[count] = new librarians(name, password, Id , email, address, city, contactno);
        try {
            SaveFile();
        ...
        this.hide();
            ...
            JOptionPane.showMessageDialog(this, "invalid emaail or ID or contact Number");
        } 
